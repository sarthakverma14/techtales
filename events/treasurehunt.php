...
<head>
    <meta charset="utf-8" />
    <title>TechTales | Treasure Hunt </title>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>Team Size:
Minimum 3 Members, Maximum 5 Members</li>
                                               

This will be a Treasure Hunt in which the people will
find the clues in a sequential manner using the ROAR App.</li>
                            ...
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Mehil Shah : +919429357646<br>
Aditya Misra : +919660407963<br>
Kunal Anand : +918800906881<br>
                                        </div>
                                    </div>
                                </div>
                            </li>
