...
<head>
    <meta charset="utf-8" />
    <title>TechTales | Road Redemption </title>
                        ...
                        <ul class="timeline">
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>Arrive 10 min before your match.</li>
                                                <li>Bring your own Controllers.(No substitutes will be provided)</li>
                                                <li>participants are not allowed to use the keyboard of the system they are gaming on, Bring your own if participants prefer those.</li>
                                                <li>participants can choose any Bike and weapon. Provided they are available in our version of the game.</li>
                                                <li>participants cannot change the graphics setting of the host system , this is to ensure smooth gameplay.</li>
                                                <li> participants cannot change the game mode from classic quick play.</li>
                                                </ul><br><br>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Registration Fees: Rs 50/person
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Coordinators - Sayam Dhingra(9999381986)<br>
                                            Nikhil Tyagi(9660332320)
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            5:30-8pm on 16th-17th November<br>
                                            and 9-12am and 1-6pm on 18th November
                                        </div>
                                    </div>
                                </div>
                            </li>
