...
<head>
    <meta charset="utf-8" />
    <title>TechTales | Codemingle </title>
                        ...
                        <ul class="timeline">
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>A team should have 2 to 4 people.</li>
                                                <li>A team can bring at	most one laptop.</li>
                                                <li>A team can choose for 2 PCs	or 1 PC	and	their laptop.</li>
                            ...
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Ayush Mahajan(7340000493)<br>
                                            Naman Kapoor(9935332644)<br>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            5:30-8pm on 17th November <br>
                                            and 4-7:30pm on 18th November
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Lab 111 on 17th November and Lab 112 on 18th November<br>
                                            Academic Block 1
                                        </div>
                                    </div>
                                </div>
