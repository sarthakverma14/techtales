                        ...
                        <ul class="timeline">
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            <ul>
                                                <li>1 vs 1 event</li>
                                                <li>Difficulty:Legendary</li>
                                                <li>Custom Tactics:not allowed</li>
                                                <li>Defending:Tactical defending</li>
                                                <li>Half time:5mins</li>
                                                <li>World XI and Classic XI not allowed</li>
                                            </ul><br><br>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <li>
                                ...
                                <div class="data">
                                    ...
                                    <div class="text row">
                                        <div class="col-md-12">
                                            Coordinators - Mehul Jhaver(9100940979)
